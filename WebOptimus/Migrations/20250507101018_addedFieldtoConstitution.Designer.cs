...
namespace WebOptimus.Migrations
{
    ...
    [Migration("20250507101018_addedFieldtoConstitution")]
    partial class addedFieldtoConstitution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebOptimus.Models.Cause", b =>
                {
                    ...
                    b.Property<decimal>("MissPaymentAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebOptimus.Models.Constitution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOptimus.Models.CustomPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOptimus.Models.Dependant", b =>
                {
                    ...
                    b.Property<bool?>("HasChangedFamily")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WebOptimus.Models.DependentChecklistItem", b =>
                {
                    ...
                    b.Property<decimal?>("MissedPayment")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebOptimus.Models.DonationForNonDeathRelated", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ApprovalOrDeclinerNote")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("DonationForNonDeathRelated");
                });
            ...
            modelBuilder.Entity("WebOptimus.Models.NoteChangeLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOptimus.Models.NoteHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOptimus.Models.NoteType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 5, 7, 10, 10, 15, 901, DateTimeKind.Utc).AddTicks(4722),
                            TypeName = "Account"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2025, 5, 7, 10, 10, 15, 901, DateTimeKind.Utc).AddTicks(4725),
                            TypeName = "Complaints"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2025, 5, 7, 10, 10, 15, 901, DateTimeKind.Utc).AddTicks(4726),
                            TypeName = "Payments"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2025, 5, 7, 10, 10, 15, 901, DateTimeKind.Utc).AddTicks(4727),
                            TypeName = "General"
                        });
                });

            modelBuilder.Entity("WebOptimus.Models.OtherDonationPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OtherDonationPayment");
                });
            ...
            modelBuilder.Entity("WebOptimus.Models.PaymentSession", b =>
                {
                    ...
                    b.Property<decimal?>("StripeActualFees")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("WebOptimus.Models.RequestToCancelMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CancelWithFamilyMembers")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("RequestToCancelMembership");
                });

            modelBuilder.Entity("WebOptimus.Models.ScheduledTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOptimus.Models.NoteHistory", b =>
                {
                    b.HasOne("WebOptimus.Models.NoteType", "NoteType")
                        .WithMany()

...
namespace WebOptimus.Migrations
{
    ...
    [Migration("20240919214119_PaymentSessionDependentTable")]
    partial class PaymentSessionDependentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebOptimus.Models.PaymentSessionDependent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PaymentSessionDependent");
                });
            ...
            modelBuilder.Entity("WebOptimus.Models.PaymentSessionDependent", b =>
                {
                    b.HasOne("WebOptimus.Models.Dependant", "Dependent")
                        .WithMany()
                        .HasForeignKey("DependentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebOptimus.Models.PaymentSession", "PaymentSession")
                        .WithMany()
                        .HasForeignKey("PaymentSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

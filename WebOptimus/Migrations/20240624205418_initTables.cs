        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalDeclinerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApprovalDeclinerEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SponsorsMemberName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SponsorsMemberNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SponsorLocalAdminName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SponsorLocalAdminNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RegionId = table.Column<int>(type: "int", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: true),
                    OutwardPostcode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    ISconverted = table.Column<bool>(type: "bit", nullable: true),
                    UpdateOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextOfKinTel = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CustomerRef = table.Column<string>(type: "nvarchar(max)", nullable: true),
